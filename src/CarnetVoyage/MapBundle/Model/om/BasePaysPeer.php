...
use CarnetVoyage\MapBundle\Model\map\PaysTableMap;
...
abstract class BasePaysPeer
{
    ...
    const OM_CLASS = 'CarnetVoyage\\MapBundle\\Model\\Pays';
    ...
    const VALEUR = 'Pays.valeur';

    /** the column name for the nom_fichier field */
    const NOM_FICHIER = 'Pays.nom_fichier';

    /** the column name for the valeur_fichier field */
    const VALEUR_FICHIER = 'Pays.valeur_fichier';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Valeur', 'NomFichier', 'ValeurFichier', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'valeur', 'nomFichier', 'valeurFichier', ),
        BasePeer::TYPE_COLNAME => array (PaysPeer::ID, PaysPeer::VALEUR, PaysPeer::NOM_FICHIER, PaysPeer::VALEUR_FICHIER, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'VALEUR', 'NOM_FICHIER', 'VALEUR_FICHIER', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'valeur', 'nom_fichier', 'valeur_fichier', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Valeur' => 1, 'NomFichier' => 2, 'ValeurFichier' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'valeur' => 1, 'nomFichier' => 2, 'valeurFichier' => 3, ),
        BasePeer::TYPE_COLNAME => array (PaysPeer::ID => 0, PaysPeer::VALEUR => 1, PaysPeer::NOM_FICHIER => 2, PaysPeer::VALEUR_FICHIER => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'VALEUR' => 1, 'NOM_FICHIER' => 2, 'VALEUR_FICHIER' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'valeur' => 1, 'nom_fichier' => 2, 'valeur_fichier' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PaysPeer::VALEUR);
            $criteria->addSelectColumn(PaysPeer::NOM_FICHIER);
            $criteria->addSelectColumn(PaysPeer::VALEUR_FICHIER);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.valeur');
            $criteria->addSelectColumn($alias . '.nom_fichier');
            $criteria->addSelectColumn($alias . '.valeur_fichier');
        }
    }
