...
/**
 * Base class that represents a row from the 'Contenu' table.
 *
 *
 *
 * @package    propel.generator.src.CarnetVoyage.MapBundle.Model.om
 */
abstract class BaseContenu extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CarnetVoyage\\MapBundle\\Model\\ContenuPeer';
     ...
     * @return Contenu The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ContenuPeer::ID;
        }
    ...
    public function setDestinationId($v)
    {
        ...
        if ($this->destination_id !== $v) {
            ...
            $this->modifiedColumns[] = ContenuPeer::DESTINATION_ID;
        }
    ...
    public function setNom($v)
    {
        ...
        if ($this->nom !== $v) {
            $this->nom = $v;
            $this->modifiedColumns[] = ContenuPeer::NOM;
        }
    ...
    public function setChemin($v)
    {
        ...
        if ($this->chemin !== $v) {
            $this->chemin = $v;
            $this->modifiedColumns[] = ContenuPeer::CHEMIN;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ContenuPeer::DATE;
            }
    ...
    public function setCommentaire($v)
    {
        ...
        if ($this->commentaire !== $v) {
            $this->commentaire = $v;
            $this->modifiedColumns[] = ContenuPeer::COMMENTAIRE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = ContenuPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Contenu object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ContenuPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ContenuQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ContenuPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ContenuPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ContenuPeer::DESTINATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`destination_id`';
        }
        if ($this->isColumnModified(ContenuPeer::NOM)) {
            $modifiedColumns[':p' . $index++]  = '`nom`';
        }
        if ($this->isColumnModified(ContenuPeer::CHEMIN)) {
            $modifiedColumns[':p' . $index++]  = '`chemin`';
        }
        if ($this->isColumnModified(ContenuPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(ContenuPeer::COMMENTAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`commentaire`';
        }

        $sql = sprintf(
            'INSERT INTO `Contenu` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ContenuPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ContenuPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Contenu'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Contenu'][$this->getPrimaryKey()] = true;
        $keys = ContenuPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContenuPeer::ID)) $criteria->add(ContenuPeer::ID, $this->id);
        if ($this->isColumnModified(ContenuPeer::DESTINATION_ID)) $criteria->add(ContenuPeer::DESTINATION_ID, $this->destination_id);
        if ($this->isColumnModified(ContenuPeer::NOM)) $criteria->add(ContenuPeer::NOM, $this->nom);
        if ($this->isColumnModified(ContenuPeer::CHEMIN)) $criteria->add(ContenuPeer::CHEMIN, $this->chemin);
        if ($this->isColumnModified(ContenuPeer::DATE)) $criteria->add(ContenuPeer::DATE, $this->date);
        if ($this->isColumnModified(ContenuPeer::COMMENTAIRE)) $criteria->add(ContenuPeer::COMMENTAIRE, $this->commentaire);
    ...
    {
        $criteria = new Criteria(ContenuPeer::DATABASE_NAME);
        $criteria->add(ContenuPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Contenu (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Contenu Clone of current object.
     * @throws PropelException
     */
    ...
    public function getDestination(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDestination === null && ($this->destination_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDestination->addContenus($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ContenuPeer::DEFAULT_STRING_FORMAT);
    }
