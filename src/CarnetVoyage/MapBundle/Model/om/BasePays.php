...
abstract class BasePays extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'CarnetVoyage\\MapBundle\\Model\\PaysPeer';
    ...
    /**
     * The value for the valeur_fichier field.
     * @var        string
     */
    protected $valeur_fichier;
    ...
    /**
     * Get the [valeur_fichier] column value.
     *
     * @return string
     */
    public function getValeurFichier()
    {
    ...
    public function setValeur($v)
    {
        ...
        if ($this->valeur !== $v) {
            $this->valeur = $v;
            $this->modifiedColumns[] = PaysPeer::VALEUR;
        }
    ...
    public function setNomFichier($v)
    {
        ...
        if ($this->nom_fichier !== $v) {
            $this->nom_fichier = $v;
            $this->modifiedColumns[] = PaysPeer::NOM_FICHIER;
        }
    ...
    /**
     * Set the value of [valeur_fichier] column.
     *
     * @param string $v new value
     * @return Pays The current object (for fluent API support)
     */
    public function setValeurFichier($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->valeur_fichier !== $v) {
            $this->valeur_fichier = $v;
            $this->modifiedColumns[] = PaysPeer::VALEUR_FICHIER;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->nom_fichier = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->valeur_fichier = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PaysPeer::VALEUR)) {
            $modifiedColumns[':p' . $index++]  = '`valeur`';
        }
        if ($this->isColumnModified(PaysPeer::NOM_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`nom_fichier`';
        }
        if ($this->isColumnModified(PaysPeer::VALEUR_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`valeur_fichier`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`nom_fichier`':
                        ...
                        break;
                    case '`valeur_fichier`':
                        $stmt->bindValue($identifier, $this->valeur_fichier, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getNomFichier(),
            $keys[3] => $this->getValeurFichier(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setNomFichier($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setValeurFichier($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PaysPeer::VALEUR)) $criteria->add(PaysPeer::VALEUR, $this->valeur);
        if ($this->isColumnModified(PaysPeer::NOM_FICHIER)) $criteria->add(PaysPeer::NOM_FICHIER, $this->nom_fichier);
        if ($this->isColumnModified(PaysPeer::VALEUR_FICHIER)) $criteria->add(PaysPeer::VALEUR_FICHIER, $this->valeur_fichier);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setValeurFichier($this->getValeurFichier());
