...
/**
 * Base class that represents a row from the 'Voyage' table.
 *
 *
 *
 * @package    propel.generator.src.CarnetVoyage.MapBundle.Model.om
 */
abstract class BaseVoyage extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CarnetVoyage\\MapBundle\\Model\\VoyagePeer';
     ...
     * @return Voyage The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = VoyagePeer::ID;
        }
    ...
    public function setDatedebut($v)
    {
        ...
        if ($this->datedebut !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VoyagePeer::DATEDEBUT;
            }
    ...
    public function setDatefin($v)
    {
        ...
        if ($this->datefin !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VoyagePeer::DATEFIN;
            }
        } // if either are not null
    ...
    public function setNom($v)
    {
        ...
        if ($this->nom !== $v) {
            $this->nom = $v;
            $this->modifiedColumns[] = VoyagePeer::NOM;
        }
    ...
    public function setCommentaire($v)
    {
        ...
        if ($this->commentaire !== $v) {
            $this->commentaire = $v;
            $this->modifiedColumns[] = VoyagePeer::COMMENTAIRE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->datedebut = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->datefin = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 5; // 5 = VoyagePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Voyage object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VoyagePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VoyageQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VoyagePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VoyagePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(VoyagePeer::DATEDEBUT)) {
            $modifiedColumns[':p' . $index++]  = '`dateDebut`';
        }
        if ($this->isColumnModified(VoyagePeer::DATEFIN)) {
            $modifiedColumns[':p' . $index++]  = '`dateFin`';
        }
        if ($this->isColumnModified(VoyagePeer::NOM)) {
            $modifiedColumns[':p' . $index++]  = '`nom`';
        }
        if ($this->isColumnModified(VoyagePeer::COMMENTAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`commentaire`';
        }

        $sql = sprintf(
            'INSERT INTO `Voyage` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VoyagePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VoyagePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Voyage'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Voyage'][$this->getPrimaryKey()] = true;
        $keys = VoyagePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VoyagePeer::ID)) $criteria->add(VoyagePeer::ID, $this->id);
        if ($this->isColumnModified(VoyagePeer::DATEDEBUT)) $criteria->add(VoyagePeer::DATEDEBUT, $this->datedebut);
        if ($this->isColumnModified(VoyagePeer::DATEFIN)) $criteria->add(VoyagePeer::DATEFIN, $this->datefin);
        if ($this->isColumnModified(VoyagePeer::NOM)) $criteria->add(VoyagePeer::NOM, $this->nom);
        if ($this->isColumnModified(VoyagePeer::COMMENTAIRE)) $criteria->add(VoyagePeer::COMMENTAIRE, $this->commentaire);
    ...
    {
        $criteria = new Criteria(VoyagePeer::DATABASE_NAME);
        $criteria->add(VoyagePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Voyage (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Voyage Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Voyage is new, it will return
    ...
    public function setDestinations(PropelCollection $destinations, PropelPDO $con = null)
    {
        ...
        foreach ($destinationsToDelete as $destinationRemoved) {
            $destinationRemoved->setVoyage(null);
        }
     ...
     * Otherwise if this Voyage is new, it will return
     * an empty collection; or if this Voyage has previously
     * been saved, it will retrieve related Destinations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Voyage.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Destination[] List of Destination objects
     */
    public function getDestinationsJoinRegion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = DestinationQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(VoyagePeer::DEFAULT_STRING_FORMAT);
    }
