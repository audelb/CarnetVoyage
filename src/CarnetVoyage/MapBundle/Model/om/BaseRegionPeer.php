...
use CarnetVoyage\MapBundle\Model\map\RegionTableMap;
...
abstract class BaseRegionPeer
{
    ...
    const OM_CLASS = 'CarnetVoyage\\MapBundle\\Model\\Region';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'PaysId', 'Valeur', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'paysId', 'valeur', ),
        BasePeer::TYPE_COLNAME => array (RegionPeer::ID, RegionPeer::PAYS_ID, RegionPeer::VALEUR, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PAYS_ID', 'VALEUR', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'pays_id', 'valeur', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PaysId' => 1, 'Valeur' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'paysId' => 1, 'valeur' => 2, ),
        BasePeer::TYPE_COLNAME => array (RegionPeer::ID => 0, RegionPeer::PAYS_ID => 1, RegionPeer::VALEUR => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PAYS_ID' => 1, 'VALEUR' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'pays_id' => 1, 'valeur' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(RegionPeer::VALEUR);
        } else {
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (RegionPeer::$instances as $instance)
        {
