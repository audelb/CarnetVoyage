...
class PaysTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.CarnetVoyage.MapBundle.Model.map.PaysTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('CarnetVoyage\\MapBundle\\Model\\Pays');
        ...
        $this->addColumn('valeur_fichier', 'ValeurFichier', 'VARCHAR', true, 255, null);
        // validators
    } // initialize()
    ...
    {
        $this->addRelation('Region', 'CarnetVoyage\\MapBundle\\Model\\Region', RelationMap::ONE_TO_MANY, array('id' => 'pays_id', ), null, null, 'Regions');
    } // buildRelations()
